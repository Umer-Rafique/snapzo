          ...
          <div className="mx-auto max-w-full px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:justify-start">
                ...
                <form className='w-full'>
                  ...
                  <div className="relative ml-10">
                    ...
                    <input type="search" id="default-search" className="block w-full p-4 h-10 pl-10 text-sm text-gray-900 rounded-full bg-white focus:none focus:none dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Mockups, Logos..." required />
                  </div>
                </form>
              </div>
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <HeroIconButton ButtonIcon={BellIcon} IconButtonLabel='View Menu' />
                {/* Profile dropdown */}
